...
In this respect, exchangeability-based randomization inference extends the foundational critique against experimental methods into the domain of observational methods, and provides a resolution to Freedman’s ([1991](https://doi.org/10.2307/270939)) warnings against sampling fictions in the social sciences. Just as Edgington rejected the premise of random sampling in the experimental context, Freedman ([1997](https://doi.org/10.1006/aama.1996.0501)) cautioned against relying on unverified stochastic assumptions in the nonexperimental context, arguing that doing so invents an imaginary mechanism and treats mathematical error terms as if they were physical stochastic processes. By grounding hypothesis tests strictly in the finite-sample permutation distribution generated under exchangeability, analysts obtain valid, distribution-free inference without making fictitious generalizations.
