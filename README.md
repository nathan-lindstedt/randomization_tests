...
In this respect, exchangeability-based randomization inference brings the earlier criticism against experimental methods into the domain of observational methods, but also provides a possible path around Freedman’s ([1991](https://doi.org/10.2307/270939)) warnings against fictions promulgated in the social sciences. Just as Edgington rejected the premise of random sampling in the experimental context, Freedman ([1997](https://doi.org/10.1006/aama.1996.0501)) cautioned against relying on unverified stochastic assumptions in the observational context, arguing doing so invents imaginary mechanisms and treats mathematical error terms as if they were physical processes of chance. By grounding hypothesis tests strictly in the finite-sample permutation distribution generated under exchangeability, analysts obtain valid, distribution-free inference without needing to make false generalizations.
