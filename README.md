...
In this respect, exchangeability-based randomization inference extends the foundational critique against experimental methods into the domain of observational methods, and provides a resolution to Freedman’s ([1991](https://doi.org/10.2307/270939)) warnings against sampling fictions in the social sciences. Just as Edgington rejected the premise of random sampling in the experimental context, Freedman cautioned against the widespread practice of applying asymptotic standard errors to the observational context, arguing that doing so invents an imaginary mechanism and treats mathematical error terms as if they were physical stochastic processes. By grounding hypothesis tests strictly in the finite-sample permutation distribution generated under exchangeability, analysts obtain valid, distribution-free inference without making fictitious generalizations (Freedman [2008](https://doi.org/10.1016/j.aam.2006.12.003)).
...
Freedman, D. A. 2008. "On regression adjustments in randomized experiments." *Advances in Applied Mathematics*, 40(2):180–193.
